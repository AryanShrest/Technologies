...
export function InquiryInbox() {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <div>
        <h2 className="text-2xl font-extrabold text-slate-950">Project inquiries</h2>
        <p className="mt-1 text-sm text-slate-500">
          {newCount} new lead{newCount === 1 ? '' : 's'} waiting for review.
        </p>
      </div>
          ...
          {selected && (
            <article>
              ...
              <dl className="mt-6 grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-2xl bg-slate-50 p-4">
                  <dt className="text-xs font-bold uppercase text-slate-400">Email notification</dt>
